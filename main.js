...
for(let key in weights) {
    ...
    for(let chey in weights[key]) {
        ...
        neuronChange.innerHTML = ("    postSynaptic[\"" + chey + "\"].values[nextState] += " + weights[key][chey] + ";");
    }
